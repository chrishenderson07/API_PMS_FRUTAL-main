...
class PmsController{
    async obterPorCodigo(req, res){
        ...
        try{
           if(!codigo){
            throw new ModeloInvalidoErro(400, "O Código é obrigatório para obter a variável")
           }
    ...
    async setValue(req, res){
        ...
        try {
            if(!codigo){
                throw new ModeloInvalidoErro(400, "O Código é obrigatório para alterar o valor")
            }
